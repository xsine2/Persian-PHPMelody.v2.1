...
{if isset($mm_register_fields_inject)}{$mm_register_fields_inject}{/if}
    ...
    <div class="control-group">
      ...
      <input type="checkbox" class="checkbox" id="agree" name="agree" {if $inputs.agree == 'on'}checked="checked"{/if}> <span class="help-inline">من با  <a data-toggle="modal" href="#terms" id="element" >قوانین و مقررات سایت</a> آشنا و موافق هستم .</span>
      </label>
      </div>
    </div>
