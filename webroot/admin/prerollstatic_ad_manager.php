	...
	case 'delete':
		...
		if ($id)
		{
			...
			if ( ! $ad)
			{
				...
				<div class="alert alert-error">
				<?php if (strlen($sql_err) > 0) : ?>
					A problem was encountered while updating this ad.
					<br /> 
					<strong>MySQL returned:</strong> <?php echo $sql_err;?>
				<?php else : ?>
					Could not delete this ad because it wasn't found in your database.
				<?php endif; ?>
				</div>
			...
			{
				?>
				<div class="alert alert-error">Invalid key provided. Please reload the page and try again.</div>
				<?php
				break;
			}
